...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
         ImageIcon img = new ImageIcon(getClass().getResource("/Img/jk.png"));
          Icon fondo1 = new ImageIcon(img.getImage().getScaledInstance(jLabel4.getWidth(), jLabel4.getHeight(), Image.SCALE_DEFAULT));
        jLabel4.setIcon(fondo1);
           this.repaint();
           
            ImageIcon gimg = new ImageIcon(getClass().getResource("/Img/ui.jpg"));
          Icon fondo1g = new ImageIcon(gimg.getImage().getScaledInstance(jLabel3.getWidth(), jLabel3.getHeight(), Image.SCALE_DEFAULT));
        jLabel3.setIcon(fondo1g);
           this.repaint();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     pasw=jTextField2.getText();
        
     //validar si estan vacio jlabel de user y pas
        if(user.isEmpty() && pasw.isEmpty() ){
            System.out.println("llene los campos");
           //validar si estan llenos 
        }else{
            if(user.equals("a") || pasw.equals("ipc1")){
         
                BotonesAdmin a = new BotonesAdmin();
                a.setVisible(true);
                this.dispose();
                
                System.out.println("contrasena y pas correctas");
               //this.dispose para que se cierre la ventana
                this.dispose();
                //validar si son incorrectos
            }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     RegistroCilente r= new RegistroCilente();
     r.setVisible(true);
