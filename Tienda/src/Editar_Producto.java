...
public class Editar_Producto extends javax.swing.JFrame {
     ...
     public static DefaultTableModel tablaeditar;
  public static int idne=0;
  public static int pne=0;
     public static int row;
    public Editar_Producto() {
        initComponents();
        
        tablaeditar=(DefaultTableModel)jTable1.getModel();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Descripcion", "Precio", "Existencia", "Direccion Img"
            }
        ));
  ...
  jTextField5.setText(jTable1.getValueAt(row, 4).toString());    
    jTextField7.setText(jTable1.getValueAt(row, 5).toString());    
        ...
        System.out.println("valor "+Agrega_producutos.idn);
