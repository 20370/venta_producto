...
public class RegistroCilente extends javax.swing.JFrame {


    public RegistroCilente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Tarjeta de credito/debito");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      NodoCliente nuevo = new NodoCliente(jTextField1.getText(), jTextField2.getText(),jTextField3.getText(),jTextField4.getText(),jTextField6.getText(),jTextField5.getText());
        if(NodoCliente.cabeza==null){
            
            NodoCliente.cabeza = nuevo;
            System.out.println("if "+NodoCliente.cabeza.getNombrec());
...
//           ,cabeza.getTarjeta(),cabeza.getTipo()});
           ...
           NodoCliente.aux = NodoCliente.cabeza;
             System.out.println("while else"+ NodoCliente.aux.getNombrec());
            while( NodoCliente.aux.getSiguiente()!= NodoCliente.cabeza){
            NodoCliente.aux = NodoCliente.aux.getSiguiente();
            
//                System.out.println("while "+ NodoCliente.aux.getNombrec());
                
            }
             NodoCliente.aux.setSiguiente(nuevo);
             nuevo.setSiguiente(NodoCliente.cabeza);
        }
...
//     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroCilente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroCilente().setVisible(true);
            }
        });
    }
